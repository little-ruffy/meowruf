...
class PatchEmbedding(nn.Module):
    def __init__(self, d_model, patch_len, stride, padding, dropout, c_in=1, position_embedding=True):
        ...
        self.value_embedding = nn.Linear(patch_len * c_in, d_model, bias=False)
